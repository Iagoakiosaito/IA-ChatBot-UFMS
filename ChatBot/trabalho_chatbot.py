...
dict_prec = {
    "caderno": 15.5, "cadernos": 15.5, "lapis": 2.5, "livro": 50 , "livros" : 50, "caneta" : 3.5, "canetas" : 3.5, "canetinha": 12.80, "canetinhas": 12.80,
...
while breaker != True:
    ...
    data_user = input(str("Insira aqui sua frase: "))
